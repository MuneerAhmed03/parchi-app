...
const UserCard: FC<UserCardProps> = ({ playerName, playerAvtar, playerStatus, tilt }) => {
  return (
    <div
      className="bg-white flex flex-col p-3 items-center justify-around w-[420px] h-48 border-2 border-black rounded-xl transition-all duration-300 ease-in-out"
      style={{
    ...
    >
      ...
      <p className="font-bold text-xl font-pencil">{playerName}</p>
